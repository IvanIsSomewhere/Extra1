...
from functions.A12_HILLCLIMBING import execute_hc
...
st.write("Hill Climbing es un algoritmo que busca el óptimo local moviéndose paso a paso hacia soluciones mejores."
         " Es rápido y sencillo, pero se puede atascar en máximos locales. Ideal para problemas con soluciones"
         " cercanas y fáciles de evaluar.")
...
with col1:
    ...
    if st.button("Correr Funcion"):
        _result, _default_plot_y = execute_hc(seleccion_algoritmo)
