...
st.write("Random Walk es un algoritmo sencillo que explora soluciones mediante movimientos aleatorios,"
         " sin reglas fijas de optimización. Su principal ventaja es su flexibilidad para abordar problemas complejos"
         " o de alta dimensionalidad donde otros métodos fallan")
