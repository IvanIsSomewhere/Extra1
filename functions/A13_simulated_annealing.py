...
def simulated_annealing(f, x0 = None,x_a = 0,x_b = 1, step = 0.2,  max_iter = 1000):
    if x0 is None:
        x0 = [0,1]
    ...
    for i in range(max_iter):
        ...
        if f(xnext) < f(xbest) or (rng.randint(1,3) == 3):
            print("new_minimum")
            xbest = xnext
            i_best = iteration
...
def ejecutar_sa(id):
    ...
    return simulated_annealing(func, x0, a, b)

#a,b = ejecutar_sa("rastrigin")
